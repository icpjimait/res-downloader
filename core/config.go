...
func getDefaultMimeMap() map[string]MimeInfo {
	return map[string]MimeInfo{
		...
		"video/tos":                     {Type: "video", Suffix: ".mp4"},
		"application/x-mp4":             {Type: "video", Suffix: ".mp4"},
		"video/mp2t":                    {Type: "video", Suffix: ".ts"},
		"video/x-m4v":                   {Type: "video", Suffix: ".m4v"},
		"video/iso.segment":             {Type: "video", Suffix: ".mp4"},
